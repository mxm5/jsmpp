...
public class SubmitMultipartMultilangualExample {
    ...
    private void sendAndWait() throws IOException, InterruptedException {
        ...
        String sourceMsisdn = sourcePhoneNumber;
        String destinationMsisdn = destinationPhoneNumber;
        ...
        try {
            session.connectAndBind(serverIpAddress, serverPortNumber, new BindParameter(
                    bindTrx,
                    userName,
                    password,
                    providedSystemType,
